...
namespace structures
{
	...
	{
		//TODO 03: ArrayList
		DSRoutines::rangeCheckExcept(index, size_, "ArrayList<T>::operator[] : Pozor na index");
		return (*array_)[index];
	...
	{
		//TODO 03: ArrayList
		DSRoutines::rangeCheckExcept(index, size_, "Pozor na index");
		return (*array_)[index];
	}
	...
	{
		//TODO 03: ArrayList
		//vytvor nove pole s novou velkostou
		//prekopiruj stare data do noveho pola
		//vymaz stare pole
		//array_ = nove pole
		Array<T>* temp = new Array<T>(size_ * 2);
		Array<T>::copy(*array_, 0, *temp, 0, size_);
		delete array_;
		array_ = temp;
	...
	{
		//TODO 03: ArrayList
		//to pretypovanbie - vytvarame na stacku kamarata ktory pretypuje z haldy
	...
	{
		//TODO 03: ArrayList
		//ak nemame rovnake pozicie alebo mame rozdielne struktury
