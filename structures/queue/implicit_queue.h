...
namespace structures
{
	...
	inline ImplicitQueue<T>& ImplicitQueue<T>::operator=(const ImplicitQueue<T>& other)
	{
		...
		if (this != &other)
		{
			...
			{
				throw std::out_of_range("ImplicitQueue<T>::operator=: Nedostatocna kapacita");
			}
	...
	inline void ImplicitQueue<T>::push(const T& data)
	{
		...
		{
			throw std::out_of_range("ImplicitQueue<T>::push: Nedostatocna kapacita");
		}
	...
	inline T ImplicitQueue<T>::pop()
	{
		...
		{
			throw std::out_of_range("ImplicitQueue<T>::pop: Nedostatocna kapacita");
		}
	...
	inline T& ImplicitQueue<T>::peek()
	{
		...
		{
			throw std::out_of_range("ImplicitQueue<T>::peek: Nedostatocna kapacita");
		}
